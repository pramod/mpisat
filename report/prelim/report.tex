...
Large number of different algorithms and their variations have been proposed for 
this problem in the recent years. Basically, there are two main classes of modern 
algorithms that are used to solve the SAT problem in practice: conflict-driven 
clause learning algorithm and stochastic local search algorithms. Parallel modifications 
...
Lewis2007MiraXT}. At MiraXT~\cite{Lewis2007MiraXT} the threads share a database with 
...
\item We would like to see whether message passing would have any advantage over
...
Modern solvers since Chaff~\cite{Moskewicz2001Chaff} maintain an ``activity factor'' for
each variable that is a measure of the number of conflicts a variable has
