...
can only be satisfied by giving such a value to the literal that makes it true. This
action is repeated until there is no such clauses.
...
a divide-and-conquer strategy to ensure that the different processes are working
on different parts of the search space. However, processes co-operate with each
other by sharing learned clauses. We do not use any concurrent data 
